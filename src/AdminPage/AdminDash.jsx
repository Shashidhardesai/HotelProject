...
const AdminDash = () => {
  ...
  const [events, setEvents] = useState([
    { id: "16/07/2024", time: "9:50am", hall: "Kings court hall", des: "WonderFest" },
    { id: "16/07/2024", time: "11:00am", hall: "court hall", des: "Innovation Ignited" },
    { id: "17/07/2024", time: "10:00am", hall: "Garden Center", des: "Fitness Frenzy" },
    { id: "17/07/2024", time: "4:00pm", hall: "Function hall", des: "Melody Mania " },
    { id: "18/07/2024", time: "10:00am", hall: "Kings court hall", des: "Garden Area" },
  ]);
  ...
  const handleDateChange = (date) => {
    ...
    const filtered = events.filter(event => event.id === selectedDateString);
