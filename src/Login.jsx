  ...
  const handleLogin = (e) => {
    ...
    if (validateForm()) {
      ...
      if (account) {
        ...
        if (loginData.email.startsWith('ADM')) {
          navigate('/AdminDash', { state: { userId: account._id } });
        } else {
  ...
  return (
    <div className='login-body'>
      <div className='login-container'>
        ...
        <Link to="/Forgot" style={{ textDecoration: "none" }}><p className='forget'>Forgot password?</p></Link>
      </div>
    </div>
  );
};
