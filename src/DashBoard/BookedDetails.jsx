...
const BookedDetails = () => {
  ...
  const fetchdata = async () => {
    try {
      const response = await axios.get(`http://localhost:5000/bookeddetailss/${id}`);
      ...
      setFormData({
        ...
        releaseddate: formatDate(data.releaseddate)
      });
    } catch (error) {
        ...
        <div className='bookdetails-container'>
          ...
          <div className='stay-container'>
            <div className='stay-col'>
              ...
              <div className="stay-row">
                <label>Nights:</label>
                <input type="number" name="nights" value={formData.nights} onChange={handleChange} required />
              </div>
              <div className="stay-row">
                <label>Extra bed:</label>
                <input type="number" name="extrabed" value={formData.extrabed} onChange={handleChange} required />
              </div>
              <div className="stay-row">
        ...
        <div className='paymain-container'>
          ...
          <div className='pay-container'>
            <div className='pay-col'>
              ...
              <div className="pay-row">
                <label>Bill to:</label>
                <select name="billto" value={formData.billto} onChange={handleChange} required>
                  <option value="">select</option>
              ...
              <div className="pay-row">
                ...
                <input type="text" name="pnote" value={formData.pnote} onChange={handleChange} required />
              </div>
              </div>
            </div>
          </div>
